...
svgEditor.addExtension("server_opensave", {
	callback: function() {
		...
		var save_svg_action = jspath+'extensions/filesave.php';
		var save_png_action = jspath+'extensions/filesave.php';
		...
		var open_svg_action = jspath+'extensions/fileopen.php?type=load_svg';
		var import_svg_action = jspath+'extensions/fileopen.php?type=import_svg';
		var import_img_action = jspath+'extensions/fileopen.php?type=import_img';
