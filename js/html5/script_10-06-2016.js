...
function generate_side(){
	...
	else
	{
		...
		// var customize_txt = $j("#textsvg_"+curr_side_id).val();
		// $j('.customize_txt').html(customize_txt);

		// if($j(document).width() < 650){
		// 	var bg_w = $j('#canvasBackground').attr('width');
		// 	var bg_h = $j('#canvasBackground').attr('height');
		// 	$j('.customize_txt svg').attr('width',bg_w)
			
		// 	if(useScissors == 1){
		// 		$j('.customize_txt svg').attr('height', parseFloat(bg_h) + parseFloat(extraHeight));
		// 	}else{
		// 		$j('.customize_txt svg').attr('height',bg_h)	
		// 	}
			
		// 	console.log('Height and wisdht is applied successfully');
		// }
		...
		if(useScissors == 1){
			...
			if($j(".hidSvg .smileyImage")[0])
			{
				...
				// if(typeof $j(".hidSvg .smileyImage").attr('href') != 'undefined' && $j(".hidSvg .smileyImage").attr('href') != '' && $j(".hidSvg .smileyImage").attr('href') != null){
				// 	var safari_href = $j(".hidSvg .smileyImage").attr('href');
				// 	$j(".hidSvg .smileyImage").removeAttr('href');
				// 	$j(".hidSvg .smileyImage").attr('xlink:href',safari_href);
				// }
		...
		label_svg = label_svg.replace('112px','112');
