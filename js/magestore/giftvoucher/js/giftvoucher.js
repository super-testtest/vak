...
day_to_send_error = 'We cannot send this giftcard in the past.';
...
function validateInputRange(el, from, to) {
...
Event.observe(window, 'load', function() {
        if (order) {
            ...
            order.loadArea(['items', 'shipping_method', 'totals', 'billing_method'], true, {reset_shipping_method: false});
        }
    });