...
<script type="text/javascript">replacehtmldata('<?php echo $htmldata;?>');
</script>
<a id="go_back" href="<?php echo Mage::getBaseUrl();?>js/PHP/Samples_ImageUploaderFlashPHP/CustomizationDemo/LocalizationDemo/index.php?uniqueid=d8fd93f76a0f3bb689684ab91d7cdfca26970633523573458" >+ Upload Images</a>
</div>
<?php
  // Get body content
