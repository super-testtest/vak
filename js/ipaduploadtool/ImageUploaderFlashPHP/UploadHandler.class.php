...
class UploadHandler {
  ...
  public function setFileUploadedCallback($callback) {
  	...
  	//echo "hiii<pre>";print_r($this->_fileUploadedCallback);exit;
  }
  ...
  public function processRequest() {
    ...
    if (!empty($_POST[UPLOADER_COOKIE_PARAM_NAME])) {
    	$cookies_string = $_POST[UPLOADER_COOKIE_PARAM_NAME];
		  UploaderUtils::fixCookie($_COOKIE, $cookies_string);
    }

    $uploadCache = new UploadCache($this->_cacheRoot, $this->_cacheAliveTimeout);
    ...
    //echo "/var/www/html/html5productbuilder/ipaduploadtool/UploadedFiles/piggy.jpg";
//echo "<pre>";print_r($uploadSession);exit;
