<?php
class W3Themes_Themeoptions_Block_Adminhtml_System_Config_Form_Field_Customfieldpattern extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        if ($many_val) {
            foreach ($many_val as $curr_val) {
                ...
                if ($curr_val['value'])$output.= '<div style="height:30px;background:url('.Mage::getDesign()->getSkinUrl('w3themes/images/'.$curr_val['value'].'.png').')">&nbsp;</div>';
