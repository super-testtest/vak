 ...
 */
class Mage_Checkout_Block_Productbuilder_Item_Renderer_Grouped extends Mage_Checkout_Block_Productbuilder_Item_Renderer
{
    const GROUPED_PRODUCT_IMAGE = 'checkout/productbuilder/grouped_product_image';
