 ...
 */
class Mage_Checkout_Model_Productbuilder extends Varien_Object implements Mage_Checkout_Model_Cart_Interface
{
    /**
    ...
    {
        return Mage::getResourceSingleton('checkout/productbuilder');
    }
