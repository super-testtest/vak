...
class Mage_Catalog_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    ...
    public function getSourceModel()
    {
        ...
        if (empty($model)) {
            if ($this->getBackendType() == 'int' &&  (($this->getFrontendInput() == 'select') || ($this->getFrontendInput() == 'colorpicker'))) {
    ...
    {
      $allowedInputTypes = array('text', 'multiselect','colorpicker', 'textarea', 'date', 'datetime', 'select', 'boolean', 'price');
    ...
    public function isIndexable()
    {
        ...
        if (($backendType == 'int' && $frontendInput == 'select') || ($backendType == 'int' && $frontendInput == 'colorpicker')) {
            return true;
