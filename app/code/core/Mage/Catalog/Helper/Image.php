...
class Mage_Catalog_Helper_Image extends Mage_Core_Helper_Abstract
{
    ...
    public function init(Mage_Catalog_Model_Product $product, $attributeName, $imageFile=null)
    {
        ...
        if ($imageFile) {
            Mage::log($imageFile,null,'fferror.log');
            $this->setImageFile($imageFile);
        } else {
            // echo 'ytestst';exit;
            // Mage::log($this->_getModel()->getDestinationSubdir(),null,'fferror.log');
            // Mage::log($this->getProduct()->getData($this->_getModel()->getDestinationSubdir()),null,'fferror.log');
