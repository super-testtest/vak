 ...
 * @module     Checkout
 */
class Mage_Checkout_Block_Productbuilder_Item_Configure extends Mage_Core_Block_Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($block) {
             $block->setSubmitRouteData(array(
                'route' => 'checkout/productbuilder/updateItemOptions',
        ...
        if ($block) {
            $block->setTemplate('checkout/productbuilder/item/configure/updatecart.phtml');
        }
