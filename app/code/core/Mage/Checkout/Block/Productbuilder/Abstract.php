 ...
 */
abstract class Mage_Checkout_Block_Productbuilder_Abstract extends Mage_Core_Block_Template
{
    ...
    {echo 'inside';exit;
        parent::__construct();
        $this->addItemRender('default', 'checkout/productbuilder_item_renderer', 'checkout/productbuilder/item/default.phtml');
    }
     ...
     * @return  Mage_Checkout_Block_Productbuilder_Abstract
     */
