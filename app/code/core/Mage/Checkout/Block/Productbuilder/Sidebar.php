 ...
 */
class Mage_Checkout_Block_Productbuilder_Sidebar extends Mage_Checkout_Block_Productbuilder_Abstract
{
    ...
    {
        parent::__construct();
        $this->addItemRender('default', 'checkout/productbuilder_item_renderer', 'checkout/productbuilder/sidebar/default.phtml');
    }
    ...
    public function getSummaryCount()
    {
        ...
        return Mage::getSingleton('checkout/productbuilder')->getSummaryQty();
    }
