...
//                            $child->setBaseUseGiftCreditAmount($child->getBaseUseGiftCreditAmount() + $discountGiftcardCredit);
//                            $child->setUseGiftCreditAmount($child->getUseGiftCreditAmount() + $store->convertPrice($discountGiftcardCredit));
//                        } else{
                            $itemDiscount = $child->getBaseRowTotal() - $child->getMagestoreBaseDiscount() - $child->getBaseDiscountAmount() + $child->getBaseTaxAmount();
