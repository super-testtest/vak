...
//                                    $discountGiftcardCredit = $itemDiscount;
//                                    $baseDiscount -= $itemDiscount;
//                                } else {
//                                    $discountGiftcardCredit = $baseDiscount;
//                                    $baseDiscount = 0;
//                                }
//                            }
//
//                            $child->setMagestoreBaseDiscount($child->getMagestoreBaseDiscount() + $discountGiftcardCredit);
//                            $child->setBaseGiftVoucherDiscount($child->getBaseGiftVoucherDiscount() + $discountGiftcardCredit);
//                            $child->setGiftVoucherDiscount($child->getGiftVoucherDiscount() + $store->convertPrice($discountGiftcardCredit));
//                        } else {
                            if (Mage::helper('tax')->priceIncludesTax())
                                $itemDiscount = $child->getRowTotalInclTax() - $child->getMagestoreBaseDiscount() - $child->getDiscountAmount();
                            else
