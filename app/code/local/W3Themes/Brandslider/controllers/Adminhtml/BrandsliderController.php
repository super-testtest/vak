...
class W3Themes_Brandslider_Adminhtml_BrandsliderController extends Mage_Adminhtml_Controller_Action
{
		...
		if ($data = $this->getRequest()->getPost()) {
			...
			if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != null) {
				try {	
					...
					$path = Mage::getBaseDir('media') . DS.'w3themes/brandslider'.DS ;
		        ...
		        $basepath=Mage::getBaseUrl().'media/w3themes/brandslider/';
		        $basepath=str_replace("index.php/","",$basepath);
	  			$data['image'] = '<img src="'.$basepath.$_FILES['image']['name'].'" width="100" alt="" />';
			}
