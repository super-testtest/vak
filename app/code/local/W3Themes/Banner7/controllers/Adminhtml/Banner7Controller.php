...
-------------------------------------------------------------------------*/ 
class W3Themes_Banner7_Adminhtml_Banner7Controller extends Mage_Adminhtml_Controller_Action
{
		...
		if ($data = $this->getRequest()->getPost()) {
			...
			if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != null) {
				try {	
					...
					$path = Mage::getBaseDir('media') . DS.'w3themes/banner7'.DS ;
		        ...
		        //$basepath=Mage::getBaseUrl().'media/w3themes/banner7/';
				$basepath='yoururl/w3themes/banner7/';
