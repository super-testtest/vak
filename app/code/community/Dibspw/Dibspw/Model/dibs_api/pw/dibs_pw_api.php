...
class dibs_pw_api extends dibs_pw_helpers {
    ...
    public function callDibsApi ($payment , $amount, $action) {
        ...
        Mage::log('=== callDibsApi ===',null,'setOrderStatusAfterPayment.log');
        Mage::log('= payment =',null,'setOrderStatusAfterPayment.log');
        Mage::log($payment,null,'setOrderStatusAfterPayment.log');
        Mage::log('= action =',null,'setOrderStatusAfterPayment.log');
        Mage::log($action,null,'setOrderStatusAfterPayment.log');
        ...
        try { 
            ...
            Mage::log('= response =',null,'setOrderStatusAfterPayment.log');
            Mage::log($response,null,'setOrderStatusAfterPayment.log');
            $phpNative = Zend_Json::decode($response->getBody());
            $status    = $phpNative['status'];
            $message   = $phpNative['declineReason'];
        } catch(Exception $e) {
            Mage::log('= Exception =',null,'setOrderStatusAfterPayment.log');
            Mage::log($e,null,'setOrderStatusAfterPayment.log');
