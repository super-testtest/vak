...
-------------------------------------------------------------------------*/ 
class W3Themes_Banner7_Block_Adminhtml_Banner7_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
    ...
    $fieldset->addField('rel', 'text', array(
          'label'     => Mage::helper('banner7')->__('Rel'),
          'required'  => false,
          'name'      => 'rel',
      ));
