 ...
 */
class Mage_Checkout_Block_Productbuilder_Item_Renderer_Configurable extends Mage_Checkout_Block_Productbuilder_Item_Renderer
{
    const CONFIGURABLE_PRODUCT_IMAGE= 'checkout/productbuilder/configurable_product_image';
