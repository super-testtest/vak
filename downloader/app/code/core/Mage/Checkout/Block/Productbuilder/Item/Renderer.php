 ...
 */
class Mage_Checkout_Block_Productbuilder_Item_Renderer extends Mage_Core_Block_Template
{
    ...
    {
        return $this->getUrl(
            'checkout/productbuilder/configure',
    ...
    public function getDeleteUrl()
    {
        ...
        return $this->getUrl(
            'checkout/productbuilder/delete',
            array(
