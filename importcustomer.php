<?php 
	...
	while(! feof($file)){
		...
		if($data['0'] != 'id'){
			...
			$city 			= $data['10'];
			$telephone 		= $data['12'];
			$companyName 	= addslashes($data['4']);
			$bill_address1  = addslashes($data['7']);
			$bill_address2  = addslashes($data['8']);

			$ship_address1	= addslashes($data['19']);
			$ship_address2	= addslashes($data['20']);
